    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
      <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <button class="btn btn-primary shadow-md mr-2">
          <router-link :to="{ path: '/todo-form' }">Add new todo</router-link>
        </button>
        <Dropdown>
        ...
        <table class="table table-report -mt-2">
          <thead>
            <tr>
              ...
              <th class="whitespace-nowrap">TODO TITLE</th>
          ...
          <tbody>
            <tr v-for="(faker, fakerKey) in $_.take($f(), 9)" :key="fakerKey" class="intro-x">
              ...
              <td>
                <a href="" class="font-medium whitespace-nowrap">this is title todo</a>
                <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">
                  this is Classification
                </div>
              </td>
              <td class="text-center">this is title</td>
              <td class="w-40">
                <div
