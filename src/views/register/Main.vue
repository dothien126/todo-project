        ...
        <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
          ...
          >
            ...
            <div class="intro-x mt-2 text-slate-400 dark:text-slate-400 xl:hidden text-center">
              A few more clicks to sign in to your account. Manage all your e-commerce accounts here
            </div>
...
import { useAuthStore } from '../../stores/handle/auth';
...
export default defineComponent({
  ...
  setup() {
    ...
    const handleRegister = async (event) => {
      ...
      const res = await axios.post('user', registerForm);
